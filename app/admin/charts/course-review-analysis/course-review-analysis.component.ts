...
@Component({
  selector: 'app-course-review-analysis',
  templateUrl: './course-review-analysis.component.html',
  styleUrls: ['./course-review-analysis.component.css']
})
export class CourseReviewAnalysisComponent implements OnInit {
  ...
  onGetFeedbackData() {
    this.serverData.getData('Analysis/Student Course Review')
      .subscribe(
        (response: Response) => {
